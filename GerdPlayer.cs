...
namespace GMR
{
	public partial class GerdPlayer : ModPlayer
	{
		...
		{
			player.QuickSpawnItem(Player.GetSource_FromThis(), ModContent.ProjectileType<Items.Accessories.MayDress>(), 1); //Should hopefully summon the accessory
		}

		public override bool PreHurt(bool pvp, bool quiet, ref int damage, ref int hitDirection, ref bool crit, ref bool customDamage, ref bool playSound, ref bool genGore, ref PlayerDeathReason damageSource, ref int cooldownCounter)
		{
			if (BLBook || MayDress != null)
			{
