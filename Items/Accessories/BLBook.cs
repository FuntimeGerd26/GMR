		...
		public override void UpdateAccessory(Player player, bool hideVisual)
		{
			...
			{ 
				...
				for (int i = 0; i < max; i++)
				{
					...
					Projectile.NewProjectile(Item.GetSource_FromThis(), player.Center, perturbedSpeed, ModContent.ProjectileType<Projectiles.Melee.BLBook>(), Item.damage, 8f, player.whoAmI, 0, (player.Center - 80 * Vector2.UnitX - player.position).Length() * (flip ? 1 : -1));
				}
			}
		}
