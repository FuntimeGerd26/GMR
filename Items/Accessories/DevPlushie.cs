...
namespace GMR.Items.Accessories
{
	public class DevPlushie : ModItem
	{
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemID.Vertebrae, 14);
			...
			recipe2.AddIngredient(ItemID.HellstoneBar, 12);
			recipe2.AddIngredient(ItemID.HallowedBar, 8);
			recipe2.AddIngredient(ItemID.Silk, 14);
			recipe2.AddIngredient(ItemID.RottenChunk, 14);
			recipe2.AddIngredient(ItemID.SoulofSight, 8);
			recipe2.AddIngredient(ItemID.CrossNecklace);
