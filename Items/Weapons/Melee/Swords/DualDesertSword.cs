...
{
	public class DualDesertSword : ModItem
	{
        ...
        {
            Item.DefaultToDopeSword<Projectiles.Melee.CoolSwords.DualDesertSword>(18);
            Item.useTime /= 2;
            Item.SetWeaponValues(54, 8f, 4);
            Item.width = 98;
            Item.height = 98;
		...
		public override void AddRecipes()
		{
			...
			recipe3.AddIngredient(null, "DualDesertAxe");
		...
		{
			Texture2D texture = ModContent.Request<Texture2D>("GMR/Items/Weapons/Melee/Swords/DualDesertSword_Glow", AssetRequestMode.ImmediateLoad).Value;
			spriteBatch.Draw
			(
				texture,
				new Vector2
