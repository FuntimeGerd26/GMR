...
namespace GMR.Items.Weapons.Melee
{
	public class XShotVice : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("Shoots a blade which slows down until it's immobile\n'Technology has lead to strange discoveries'");
		...
		{
			Item.rare = ItemRarityID.LightRed; // Assign this item a rarity level of Light Red
