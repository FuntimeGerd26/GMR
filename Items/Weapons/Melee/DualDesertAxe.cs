...
namespace GMR.Items.Weapons.Melee
{
	public class DualDesertAxe : ModItem
	{
        ...
        {
            Item.DefaultToDopeSword<Projectiles.Melee.CoolSwords.DualDesertAxe>(25);
            Item.useTime /= 4;
            Item.SetWeaponValues(55, 4.5f, 14);
            Item.width = 94;
            Item.height = 94;
		...
		{
			Texture2D texture = ModContent.Request<Texture2D>("GMR/Items/Weapons/Melee/DualDesertAxe_Glow", AssetRequestMode.ImmediateLoad).Value;
			spriteBatch.Draw
			(
				texture,
				new Vector2
