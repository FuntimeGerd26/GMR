...
namespace GMR.Items.Weapons.Melee
{
	public class DualDesertSword : ModItem
	{
        ...
        public override void SetDefaults()
        {
            ...
            Item.useTime /= 2;
            Item.SetWeaponValues(58, 4.5f, 4);
            Item.width = 98;
            Item.height = 98;
		...
		{
			Texture2D texture = ModContent.Request<Texture2D>("GMR/Items/Weapons/Melee/DualDesertSword_Glow", AssetRequestMode.ImmediateLoad).Value;
			spriteBatch.Draw
			(
				texture,
				new Vector2
