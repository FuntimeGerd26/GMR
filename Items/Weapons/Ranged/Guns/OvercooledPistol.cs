...
namespace GMR.Items.Weapons.Ranged.Guns
{
	public class OvercooledPistol : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
            Item.UseSound = new SoundStyle("GMR/Sounds/Items/Ranged/BulletShot1") { Volume = 0.25f, PitchVariance = 0.25f, };
			...
			Item.shoot = ProjectileType<OvercooledPistolHeldProj>();
			Item.shootSpeed = 18f;
    ...
    public class OvercooledPistolHeldProj : ModProjectile, IDrawable
    {
        ...
        private void ShootBullets(int bulletType, int amount, Vector2 from, Vector2 velocity)
        {
            for (int i = 0; i < amount; i++)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle($"{nameof(GMR)}/Sounds/Items/Ranged/BulletShot1") { Volume = 0.25f, PitchVariance = 0.2f, }, Projectile.Center);
        ...
        public override void AI()
        {
            ...
            if (Main.myPlayer == Player.whoAmI)
            {
                ...
                float attackBuffs = (Player.GetAttackSpeed(DamageClass.Ranged) + Player.GetAttackSpeed(DamageClass.Generic)) * 0.75f;
                if (attackBuffs < 1f)
                    attackBuffs = 1f;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Vector2 normOrigin = new Vector2(-7f, 8f) + Vector2.UnitX * recoil.X;
