...
{
	public class StopAura : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Aura Effect");
		...
		public override Color? GetAlpha(Color lightColor) => new Color(55, 255, 255, 55);
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Color color26 = new Color(55, 255, 255, 55);
