...
{
	public class ScarletRocketWait : ModProjectile
	{
		public override string Texture => "GMR/Projectiles/Ranged/ScarletRocket";
		...
		public override void AI()
        {
			...
			{
				Projectile.velocity = 0.001f / Projectile.MaxUpdates * Vector2.Normalize(Projectile.velocity);
			}
		}
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<Projectiles.SmallExplosion>(), damageDone / 2, Projectile.knockBack, Main.myPlayer);
		...
		{
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 0f, ModContent.ProjectileType<Projectiles.Explosion>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
			SoundEngine.PlaySound(SoundID.Item62, Projectile.position);
