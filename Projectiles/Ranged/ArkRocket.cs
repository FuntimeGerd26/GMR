...
{
	public class ArkRocket : ModProjectile
	{
		public override string Texture => "GMR/Projectiles/Ranged/UltraBlueRocket";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Ark Rocket");
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			int dustId2 = Dust.NewDust(Projectile.position, Projectile.width / 2, Projectile.height / 2, 60, Projectile.velocity.X * 0.7f,
				Projectile.velocity.Y * 0.7f, 15, Color.White, 2f);
		...
		{
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 0f, ModContent.ProjectileType<Projectiles.ArkBomb>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
			SoundEngine.PlaySound(SoundID.Item62, Projectile.position);
