...
{
	public class AncientShuriken : ModProjectile
	{
		public override string Texture => "GMR/Items/Weapons/Ranged/Others/AncientShuriken";
		...
		{
			Projectile.rotation += 0.3f * Projectile.velocity.Length();
		}
