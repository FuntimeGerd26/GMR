...
namespace GMR.Projectiles.Ranged
{
	public class AlloybloodSaw : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				if (Projectile.ai[0] < 5f && target != null)
				{
					int p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Normalize(Projectile.Center - target.Center) * 2f, Projectile.type, (int)(Projectile.damage / 2f), Projectile.knockBack, Main.myPlayer, 5f);
