...
namespace GMR.Projectiles.Ranged
{
	public class NeonGunSlash : ModProjectile
	{
		...
		public override Color? GetAlpha(Color lightColor) => new Color(253, 218, 255, 165);
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			for (int i = 0; i < numberProjectiles; i++)
			{
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, perturbedSpeed, Projectile.type, (Projectile.damage / 2) + (Projectile.damage / 4), Projectile.knockBack, Main.myPlayer);
			}
		}
