...
{
	public class MagmaKnife : ModProjectile
	{
		public override string Texture => "GMR/Items/Weapons/Ranged/Others/MagmaKnife";
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 0.1f, ModContent.ProjectileType<Projectiles.SmallExplosion>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			for (int i = 0; i < 2; i++)
			{
				for (int j = 0; j < 1; j++)
				{
					var flarePosition = ((swishRotation + MathHelper.ToRadians(-90f)) + MathHelper.ToRadians(33f) + 0.6f * (j - 1)).ToRotationVector2() * flareOffset;
