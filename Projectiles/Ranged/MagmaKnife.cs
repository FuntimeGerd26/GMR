...
namespace GMR.Projectiles.Ranged
{
	...
	{
		public override string Texture => "GMR/Items/Weapons/Ranged/MagmaKnife";
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 0.1f, ModContent.ProjectileType<Projectiles.SmallExplotion>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
