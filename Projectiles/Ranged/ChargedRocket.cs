    ...
    public class ChargedRocket : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (++Projectile.localAI[1] > 30)
            {
                ...
                if (target != -1)
                {
                    Projectile.velocity = Vector2.Lerp(Projectile.velocity, Vector2.Normalize(Main.npc[target].Center - Projectile.Center) * 18f, 0.02f);
                }
            }
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 0.1f, ModContent.ProjectileType<Projectiles.Explosion>(), Projectile.damage / 2, Projectile.knockBack, Main.myPlayer);
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 0.1f, ModContent.ProjectileType<Projectiles.Explosion>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
            SoundEngine.PlaySound(SoundID.Item62, Projectile.position);
