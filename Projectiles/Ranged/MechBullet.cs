...
namespace GMR.Projectiles.Ranged
{
    public class MechBullet : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            player.AddBuff(ModContent.BuffType<Buffs.Buff.BuiltDifferent>(), 120);

            Dust dustId = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, 72, Projectile.velocity.X * -0.7f, Projectile.velocity.Y * 0.7f, 60, default(Color), 2f);
            dustId.noGravity = true;
            Dust dustId3 = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, 72, Projectile.velocity.X * 0.7f, Projectile.velocity.Y * 0.7f, 60, default(Color), 2f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color26 = new Color(255, 55, 125);
