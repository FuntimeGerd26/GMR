...
namespace GMR.Projectiles.Ranged
{
	public class FallFireballFriendly : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 0.75f, ModContent.ProjectileType<Projectiles.Explosion>(), (int)(Projectile.damage / 2), Projectile.knockBack, Main.myPlayer);
