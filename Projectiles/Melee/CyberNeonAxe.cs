...
namespace GMR.Projectiles.Melee
{
    ...
    {
        public override string Texture => "GMR/Items/Weapons/Melee/CyberNeonAxe";
        ...
        public override void AI()
        {
            ...
            Projectile.idStaticNPCHitCooldown = 30 - (int)(15 * player.GetAttackSpeed(DamageClass.Melee) + player.GetAttackSpeed(DamageClass.Generic));
