...
namespace GMR.Projectiles.Melee.CoolSwords
{
    ...
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Swords/PrismaticMirror";
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, AngleVector * 38f, ModContent.ProjectileType<Projectiles.Melee.PrismaticBeam>(), (int)(Projectile.damage * 0.8f), Projectile.knockBack, Projectile.owner);
