...
{
    public class NeonBlade : CoolSwordBase
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (flip)
            {
                Main.instance.LoadItem(ModContent.ItemType<Items.Weapons.Melee.NeonBlade>());
                texture = TextureAssets.Item[ModContent.ItemType<Items.Weapons.Melee.NeonBlade>()].Value;
            }
            ...
            if (AnimProgress > 0.45f && AnimProgress < 0.65f)
            {
                ...
                var shineColor = new Color(200, 80, 80, 0) * intensity * intensity * Projectile.Opacity;
