...
namespace GMR.Projectiles.Melee.CoolSwords
{
    public class ShadowSword : CoolSwordBase
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (flip)
            {
                Main.instance.LoadItem(ModContent.ItemType<Items.Weapons.Melee.ShadowSword>());
                texture = TextureAssets.Item[ModContent.ItemType<Items.Weapons.Melee.ShadowSword>()].Value;
            }
