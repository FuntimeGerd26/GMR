...
namespace GMR.Projectiles.Melee.CoolSwords
{
    ...
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Others/DualDesertAxe";
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.SmallExplosion>()] < 1)
                Projectile.NewProjectile(player.GetSource_FromThis(), target.Center, new Vector2(0f, 0f), ModContent.ProjectileType<Projectiles.SmallExplosion>(), Projectile.damage / 4, Projectile.knockBack, Main.myPlayer);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (AnimProgress > 0.10f && AnimProgress < 0.90f)
            {
                ...
                Main.EntitySpriteDraw(swish, swishLocation, null, swishColor * 0.4f, r + MathHelper.PiOver2, swishOrigin, Projectile.scale * 2.2f, effects, 0);
            }
            return false;
        }
    }
