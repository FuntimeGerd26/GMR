...
{
    public class LuxLunaeProj : CoolSwordBase
    {
        public override string Texture => "GMR/Items/Weapons/Melee/LuxLunae";
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, AngleVector * Projectile.velocity.Length() * 18f, ModContent.ProjectileType<Projectiles.Melee.LuxBlade>(), Projectile.damage, Projectile.knockBack / 2f, Projectile.owner);
        ...
        {
            Player player = Main.player[Projectile.owner];
            player.AddBuff(ModContent.BuffType<Buffs.Buff.Empowered>(), 900);
            player.AddBuff(ModContent.BuffType<Buffs.Buff.CuttingEdge>(), 900);
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                Main.EntitySpriteDraw(texture, drawCoords + v * 2f * Projectile.scale, null, new Color(Main.DiscoR, 125, 255) * Projectile.Opacity, Projectile.rotation, origin, Projectile.scale, effects, 0);
            }

            Main.EntitySpriteDraw(texture, handPosition - Main.screenPosition, null, drawColor.UseA(0), Projectile.rotation, origin, Projectile.scale, effects, 0);
