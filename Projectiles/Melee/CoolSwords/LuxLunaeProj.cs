...
namespace GMR.Projectiles.Melee.CoolSwords
{
    ...
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Swords/LuxLunae";
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, AngleVector * 18f, ModContent.ProjectileType<Projectiles.Melee.LuxBlade>(), Projectile.damage, Projectile.knockBack / 2f, Projectile.owner);
