...
namespace GMR.Projectiles.Melee.CoolSwords
{
    ...
    {
        public override string Texture => "GMR/Items/Weapons/Melee/DesertAxe";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (flip)
            {
                Main.instance.LoadItem(ModContent.ItemType<Items.Weapons.Melee.DesertAxe>());
                texture = TextureAssets.Item[ModContent.ItemType<Items.Weapons.Melee.DesertAxe>()].Value;
            }
