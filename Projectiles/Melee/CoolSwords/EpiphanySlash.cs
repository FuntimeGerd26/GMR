...
{
    public class EpiphanySlash : CoolSwordBase
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Swords/Epiphany";
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            if (progress == 0.5f && Main.myPlayer == Projectile.owner)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), player.Center,
                    velocity.RotatedByRandom(MathHelper.ToRadians(3)),
                    ModContent.ProjectileType<Projectiles.Melee.Epiphany>(), (int)(Projectile.damage * 0.80f), Projectile.knockBack / 2f, Projectile.owner);
        ...
        {
            target.AddBuff(ModContent.BuffType<Buffs.Debuffs.ChillBurn>(), 1200);
            target.AddBuff(ModContent.BuffType<Buffs.Debuffs.Thoughtful>(), 900);
            int dustId = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 62, Projectile.velocity.X * 0.5f,
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                Main.EntitySpriteDraw(texture, drawCoords + v * 2f * Projectile.scale, null, new Color(5, 100, 160, 0) * Projectile.Opacity, Projectile.rotation, origin, Projectile.scale, effects, 0);
            }
            ...
            if (AnimProgress > 0.45f && AnimProgress < 0.65f)
            {
                ...
                var shineColor = new Color(40, 120, 200, 0) * intensity * intensity * Projectile.Opacity;
            ...
            if (AnimProgress > 0.35f && AnimProgress < 0.75f)
            {
                ...
                var swishColor = new Color(40, 120, 200, 125) * intensity * intensity * Projectile.Opacity * 0.5f;
                ...
                Main.EntitySpriteDraw(swish, swishLocation, null, swishColor * 0.4f, r + MathHelper.PiOver2, swishOrigin, 1.2f, effects, 0);
            }
