...
namespace GMR.Projectiles.Melee.CoolSwords
{
    public class GerdSword : CoolSwordBase
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var drawColor = Projectile.GetAlpha(new Color(125, 255, 55, 25)) * Projectile.Opacity;
            ...
            if (AnimProgress > 0.45f && AnimProgress < 0.65f)
            {
                ...
                var shineColor = new Color(125, 255, 55, 0) * intensity * intensity * Projectile.Opacity;
            ...
            if (AnimProgress > 0.35f && AnimProgress < 0.75f)
            {
                ...
                var swishColor = new Color(125, 255, 55, 25) * intensity * intensity * Projectile.Opacity * 0.5f;
                ...
                Main.EntitySpriteDraw(swish, swishLocation, null, swishColor * 0.4f, r + MathHelper.PiOver2, swishOrigin, Projectile.scale * 1.7f, effects, 0);
            }
            return false;
        }
    }
