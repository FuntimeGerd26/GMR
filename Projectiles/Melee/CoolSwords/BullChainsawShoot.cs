...
namespace GMR.Projectiles.Melee.CoolSwords
{
    ...
    {
        public override string Texture => "GMR/Items/Weapons/Melee/BullChainsawCharge";
        ...
        {
            Player player = Main.player[Projectile.owner];
            var texture = GMR.Instance.Assets.Request<Texture2D>("Items/Weapons/Melee/BullChainsawCharge", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
