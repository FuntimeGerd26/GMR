...
{
    public class BullChainsawShoot : CoolSwordBase
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Others/BullChainsawCharge";
        ...
        public override void AI()
        {
            ...
            if (!playedSound && AnimProgress > 0.4f)
            {
                ...
                SoundEngine.PlaySound(SoundID.Item23.WithPitchOffset(-0.5f), Projectile.Center);
            }
        }
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), player.Center, Projectile.velocity * 18f, ModContent.ProjectileType<Projectiles.Melee.PoisonCharge>(), (int)(Projectile.damage * 0.8f), Projectile.knockBack / 2f, Main.myPlayer);
        ...
        {
            return GenericSwing2(progress * 0.99f);
        }
        ...
        {
            Player player = Main.player[Projectile.owner];
            var texture = GMR.Instance.Assets.Request<Texture2D>("Items/Weapons/Melee/Others/BullChainsawCharge", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
            ...
            if (AnimProgress > 0.15f && AnimProgress < 0.85f)
            {
                ...
                var Color26 = new Color(255, 155, 55, 0);
