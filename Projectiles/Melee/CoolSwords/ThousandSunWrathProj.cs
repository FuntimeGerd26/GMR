...
namespace GMR.Projectiles.Melee.CoolSwords
{
    ...
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Swords/ThousandSunWrath";
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), player.Center, AngleVector * Projectile.velocity.Length() * 36f,
                    ModContent.ProjectileType<Projectiles.Melee.SunWrathSlash>(), (int)(Projectile.damage * 0.75f), Projectile.knockBack, Projectile.owner);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(player.GetSource_FromThis(), Projectile.Center, AngleVector * Projectile.velocity.Length() * 18f,
                    ModContent.ProjectileType<SunWrathExplosion>(), (int)(Projectile.damage * 0.75f), Projectile.knockBack, Projectile.owner);
    ...
    public class SunWrathExplosion : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), position, new Vector2(Projectile.direction, 0f), ModContent.ProjectileType<SunWrathExplosion>(), Projectile.damage / 4, Projectile.knockBack, Projectile.owner);
        }
