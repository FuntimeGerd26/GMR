...
namespace GMR.Projectiles.Melee.CoolSwords
{
    ...
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Swords/DualDesertSword";
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            SoundEngine.PlaySound(GMR.GetSounds("Items/Melee/SwordImpact", 3, 0.5f, 0f, 0.15f), Projectile.Center);
        }
