...
{
    public class HatefulBlade : HeldSlashingSwordProjectile
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Swords/HatefulBlade";
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            if (progress == 0.5f && Main.myPlayer == Projectile.owner)
            {
                Projectile.NewProjectile(Main.player[Projectile.owner].GetSource_HeldItem(), Projectile.Center,
                    ...
                    ModContent.ProjectileType<HatredSlash>(), (int)(Projectile.damage * 0.75f), Projectile.knockBack / 4f, Projectile.owner);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var glowColor = new Color(225, 155, 200, 0);
            ...
            if (intensity > 0f)
            {
                ...
                var shineColor = new Color(255, 120, 175, 100) * intensity * intensity * Projectile.Opacity;
