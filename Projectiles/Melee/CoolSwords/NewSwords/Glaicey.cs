...
{
    public class Glaicey : HeldSlashingSwordProjectile
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Swords/Glaicey";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (intensity > 0f)
            {
                ...
                var shineColor = new Color(30, 155, 255, 100) * intensity * intensity * Projectile.Opacity;
