...
{
    public class NeonBlade : HeldSlashingSwordProjectile
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Swords/NeonBlade";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var glowColor = new Color(225, 155, 185, 0);
            ...
            if (intensity > 0f)
            {
                ...
                var shineColor = new Color(255, 120, 120, 100) * intensity * intensity * Projectile.Opacity;
