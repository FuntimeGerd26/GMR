...
{
    public class StarMadness : HeldSlashingSwordProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (AnimProgress > 0.3f && AnimProgress < 0.6f)
            {
                ...
                for (int i = 0; i < amt; i++)
                {
                    ...
                    var d = Dust.NewDustPerfect(Main.player[Projectile.owner].Center + AngleVector * Main.rand.NextFloat(10f, 70f * Projectile.scale), 86, velocity, newColor: Color.White.UseA(0));
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            if (progress == 0.5f && Main.myPlayer == Projectile.owner)
            {
                if (modPlayer.InfraRedSet != null)
                    Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, AngleVector * 12f,
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            int dustId = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 86, Projectile.velocity.X * 0.5f,
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var glowColor = new Color(200, 125, 255, 0);
            ...
            if (intensity > 0f)
            {
                ...
                var shineColor = new Color(255, 185, 255, 100) * intensity * intensity * Projectile.Opacity;
