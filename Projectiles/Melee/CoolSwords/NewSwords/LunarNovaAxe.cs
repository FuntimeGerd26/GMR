...
{
    public class LunarNovaAxe : HeldSlashingSwordProjectile
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Others/LunarNovaAxe";
        ...
        public override void AI()
        {
            ...
            if (AnimProgress > 0.3f && AnimProgress < 0.6f)
            {
                ...
                for (int i = 0; i < amt; i++)
                {
                    ...
                    var d = Dust.NewDustPerfect(Main.player[Projectile.owner].Center + AngleVector * Main.rand.NextFloat(10f, 70f * Projectile.scale), 179, velocity, newColor: Color.White.UseA(0));
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            if (progress == 0.5f && Main.myPlayer == Projectile.owner)
            {
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), player.Center, AngleVector * Projectile.velocity.Length() * 12f,
                    ModContent.ProjectileType<Projectiles.Melee.LunarCut>(), (int)(Projectile.damage * 0.6f), Projectile.knockBack / 2f, Projectile.owner);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var glowColor = new Color(175, 55, 255, 0);
            ...
            if (intensity > 0f)
            {
                ...
                var shineColor = new Color(255, 75, 255, 100) * intensity * intensity * Projectile.Opacity;
