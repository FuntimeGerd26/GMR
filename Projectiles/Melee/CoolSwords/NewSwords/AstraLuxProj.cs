...
{
    public class AstraLuxProj : HeldSlashingSwordProjectile
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Swords/AstraLux";
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            if (progress == 0.5f && Main.myPlayer == Projectile.owner)
            {
                Projectile.NewProjectile(Main.player[Projectile.owner].GetSource_HeldItem(), Projectile.Center,
                    ...
                    ModContent.ProjectileType<AstraBlade>(), (int)(Projectile.damage * 0.75f), Projectile.knockBack / 4f, Projectile.owner);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var glowColor = new Color(255, 25, 25, 0);
            ...
            if (intensity > 0f)
            {
                ...
                var shineColor = new Color(255, 125, 125, 100) * intensity * intensity * Projectile.Opacity;
