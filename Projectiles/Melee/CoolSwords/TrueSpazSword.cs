...
{
    public class TrueSpazSword : CoolSwordBase
    {
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            if (progress == 0.5f && Main.myPlayer == Projectile.owner)
            {
                ...
                for (int i = 0; i < numberProjectiles; i++)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, perturbedSpeed, ModContent.ProjectileType<Projectiles.Melee.LostTimeBlade>(), (int)(Projectile.damage * 0.75f), Projectile.knockBack / 2f, Main.myPlayer);
                }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (flip)
            {
                Main.instance.LoadItem(ModContent.ItemType<Items.Weapons.Melee.Swords.TrueSpazSword>());
                texture = TextureAssets.Item[ModContent.ItemType<Items.Weapons.Melee.Swords.TrueSpazSword>()].Value;
            }
