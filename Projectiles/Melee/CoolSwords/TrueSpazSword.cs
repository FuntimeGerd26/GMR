...
namespace GMR.Projectiles.Melee.CoolSwords
{
    public class TrueSpazSword : CoolSwordBase
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (flip)
            {
                Main.instance.LoadItem(ModContent.ItemType<Items.Weapons.Melee.TrueSpazSword>());
                texture = TextureAssets.Item[ModContent.ItemType<Items.Weapons.Melee.TrueSpazSword>()].Value;
            }
