...
namespace GMR.Projectiles.Melee.CoolSwords
{
    public class MumeikenKyomu : CoolSwordBase
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (flip)
            {
                Main.instance.LoadItem(ModContent.ItemType<Items.Weapons.Melee.MumeikenKyomu>());
                texture = TextureAssets.Item[ModContent.ItemType<Items.Weapons.Melee.MumeikenKyomu>()].Value;
            }
