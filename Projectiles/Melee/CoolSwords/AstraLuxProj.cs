...
{
    public class AstraLuxProj : CoolSwordBase
    {
        ...
        public override void UpdateSwing(float progress, float interpolatedSwingProgress)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromAI(), player.Center, AngleVector * Projectile.velocity.Length() * 18f, ModContent.ProjectileType<Projectiles.Melee.AstraBlade>(), Projectile.damage, Projectile.knockBack / 2f, Projectile.owner);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            var drawColor = new Color(255, 25, 25) * Projectile.Opacity;
            ...
            {
                Main.EntitySpriteDraw(texture, drawCoords + v * 2f * Projectile.scale, null, drawColor * Projectile.Opacity, Projectile.rotation, origin, Projectile.scale, effects, 0);
                Main.EntitySpriteDraw(ModContent.Request<Texture2D>($"GMR/Items/Weapons/Melee/AstraLux", AssetRequestMode.ImmediateLoad).Value,
                    drawCoords + v * 2f * Projectile.scale, null, Color.White, Projectile.rotation, origin, Projectile.scale, effects, 0);
            }

            Main.EntitySpriteDraw(texture, handPosition - Main.screenPosition, null, lightColor, Projectile.rotation, origin, Projectile.scale, effects, 0);
