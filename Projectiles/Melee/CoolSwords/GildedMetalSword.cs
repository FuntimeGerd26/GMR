...
namespace GMR.Projectiles.Melee.CoolSwords
{
    public class GildedMetalSword : CoolSwordBase
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (flip)
            {
                Main.instance.LoadItem(ModContent.ItemType<Items.Weapons.Melee.GildedMetalSword>());
                texture = TextureAssets.Item[ModContent.ItemType<Items.Weapons.Melee.GildedMetalSword>()].Value;
            }
