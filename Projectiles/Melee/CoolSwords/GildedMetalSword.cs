...
namespace GMR.Projectiles.Melee.CoolSwords
{
    public class GildedMetalSword : CoolSwordBase
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (flip)
            {
                Main.instance.LoadItem(ModContent.ItemType<Items.Weapons.Melee.Swords.GildedMetalSword>());
                texture = TextureAssets.Item[ModContent.ItemType<Items.Weapons.Melee.Swords.GildedMetalSword>()].Value;
            }
            ...
            if (AnimProgress > 0.45f && AnimProgress < 0.65f)
            {
                ...
                var shineColor = new Color(255, 120, 25) * intensity * intensity * Projectile.Opacity;
            ...
            if (AnimProgress > 0.35f && AnimProgress < 0.75f)
            {
                ...
                var swishColor = new Color(255, 120, 25, 125) * intensity * intensity * Projectile.Opacity * 0.5f;
