...
namespace GMR.Projectiles.Melee.CoolSwords
{
    public class LostTime : CoolSwordBase
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (flip)
            {
                Main.instance.LoadItem(ModContent.ItemType<Items.Weapons.Melee.LostTime>());
                texture = TextureAssets.Item[ModContent.ItemType<Items.Weapons.Melee.LostTime>()].Value;
            }
