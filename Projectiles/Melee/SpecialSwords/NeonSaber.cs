...
{
    public class NeonSaber : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromAI(), new Vector2(target.Center.X + Main.rand.Next(-target.width / 2, target.width / 2),
                target.Center.Y + Main.rand.Next(-target.height / 2, target.height / 2)), Vector2.Zero, ModContent.ProjectileType<NeonHitSpark>(), 0, 0f, Projectile.owner);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = new Color(255, 20, 85); // Back Swing
            ...
            Color color2 = new Color(255, 255, 255, 125); // Front Swing
            // Color color3 = new Color(255, 255, 200, 80);
            Color color4 = new Color(255, 85, 85) * num3 * 0.5f; // Lines
    ...
    public class NeonHitSpark : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color26 = new Color(255, 85, 85, 85) * opacity;
            Scaling += -0.025f;
