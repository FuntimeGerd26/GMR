...
{
    public class VioletGreatSword : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromAI(), new Vector2(target.Center.X + Main.rand.Next(-target.width / 2, target.width / 2),
                target.Center.Y + Main.rand.Next(-target.height / 2, target.height / 2)), Vector2.Zero, ModContent.ProjectileType<VioletHitSpark>(), 0, 0f, Projectile.owner);
            SoundEngine.PlaySound(GMR.GetSounds("Items/Melee/SwordImpact", 3, 0.2f, 0.35f, 0.35f), Projectile.Center);

            Player player = Main.player[Projectile.owner];
            target.AddBuff(ModContent.BuffType<Buffs.Debuffs.Glimmering>(), 300);
        ...
        public override void AI()
        {
            ...
            float num7 = 0.6f;
            float num8 = 1f; // Increases the hitbox and visuals
            ...
            {
                Dust dust7 = Dust.NewDustPerfect(Projectile.Center + num10.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), 70, vector3 * 1f);
                dust7.fadeIn = 0.4f + Main.rand.NextFloat() * 0.15f;
                dust7.noGravity = true;
                Dust dust8 = Dust.NewDustPerfect(Projectile.Center + num10.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), 70, vector3 * 1f);
                dust8.fadeIn = 0.4f + Main.rand.NextFloat() * 0.15f;
                dust8.noGravity = true;
            }
            if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
            {
                var dust9 = Dust.NewDustPerfect(vector2, 70, vector3 * 1f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = new Color(135, 85, 205); // Back Swing
            ...
            Color color2 = new Color(200, 150, 255, 125); // Front Swing
    ...
    public class VioletHitSpark : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color26 = new Color(200, 150, 255, 125) * opacity;
            Scaling += -0.025f;
