...
{
	public class Unbending : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            NPC.HitInfo strike = modifiers.ToHitInfo(Projectile.damage * 2, flag4, num21, damageVariation: true, Main.player[Projectile.owner].luck);
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromAI(), projPos, velocityToTarget, ModContent.ProjectileType<UnbendingCut>(),
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(Projectile.Center, new Vector3(DiscoR, 0.4f, 1f));
            ...
            float num7 = 0.6f;
            float num8 = 0.85f; // Increases the hitbox and visuals
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = new Color(35, 35, 35, 255); // Back Swing
            ...
            Color color2 = new Color(125, 125, 125, 50); // Front Swing
            // Color color3 = new Color(255, 255, 200, 80);
            Color color4 = new Color(255, 255, 255, 100) * num3 * 0.8f; // Lines
            ...
            Main.spriteBatch.Draw(asset.Value, vector, (Rectangle?)asset.Frame(1, 4, 0, 3), color4 * 0.3f * num3, Projectile.rotation + Projectile.ai[0] * -0.05f, origin, num * 0.8f, effects, 0f);
            Main.spriteBatch.Draw(asset.Value, vector, (Rectangle?)asset.Frame(1, 4, 0, 3), color4 * 0.2f * num3, Projectile.rotation + Projectile.ai[0] * -0.1f, origin, num * 0.6f, effects, 0f);
            for (float num5 = 0f; num5 < 8f; num5 += 1f)
            {
                ...
                float num7 = num5 / 9f;
                DrawPrettyStarSparkle(Projectile.Opacity, 0, drawpos, new Color(125, 125, 125, 0) * num3 * num7, color2, num2, 0f, 0.5f, 0.5f, 1f, num6, new Vector2(0f, Utils.Remap(num2, 0f, 1f, 3f, 0f)) * num, Vector2.One * num);
            }
            ...
            DrawPrettyStarSparkle(Projectile.Opacity, 0, drawpos2, new Color(125, 125, 125, 0) * num3 * 0.5f, color2, num2, 0f, 0.5f, 0.5f, 1f, 0f, new Vector2(2f, Utils.Remap(num2, 0f, 1f, 4f, 1f)) * num, Vector2.One * num);
            return false;
        }
    ...
    public class UnbendingStab : ModProjectile
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Swords/Unbending";
        ...
        public override void AI()
        {
            ...
            Projectile.Center = player.MountedCenter + Vector2.SmoothStep(Projectile.velocity * 40f, Projectile.velocity * 60f, progress);
            player.velocity = Vector2.SmoothStep(Projectile.velocity * 1f, Projectile.velocity * 12f, progress) * 4f;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            float extraRot = Projectile.direction == -1 ? MathHelper.ToRadians(-45f + 180f) : MathHelper.ToRadians(45f);

            for (float i = 0; i < ProjectileID.Sets.TrailCacheLength[Projectile.type]; i += 0.5f)
            {
                Color color27 = new Color(125, 125, 125, 100);
                ...
                Main.EntitySpriteDraw(texture2D13, value4 + Projectile.Size / 2f - Main.screenPosition + new Vector2(0, Projectile.gfxOffY),
                    new Microsoft.Xna.Framework.Rectangle?(rectangle), color27, Projectile.rotation + extraRot, origin2, Projectile.scale, effects, 0);
            }

            Main.EntitySpriteDraw(texture2D13, Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY),
                new Microsoft.Xna.Framework.Rectangle?(rectangle), Projectile.GetAlpha(color26), Projectile.rotation + extraRot, origin2, Projectile.scale, effects, 0);
            return false;
        }
    }


    public class UnbendingCut : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color26 = new Color(125, 125, 125, 80);
