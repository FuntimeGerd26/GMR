...
{
	public class HeroTrainingSwordSwing : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < 15; i++)
            {
                Dust dustId2 = Dust.NewDustDirect(target.position, target.width, target.height, 163, target.velocity.X * -1.5f, target.velocity.Y * -1.5f, 60, default(Color), 1f);
                dustId2.noGravity = true;

                Dust dustId3 = Dust.NewDustDirect(target.position, target.width, target.height, 163, target.velocity.X * -1.5f, target.velocity.Y * -1.5f, 60, default(Color), 1.5f);
        ...
        public override void AI()
        {
            ...
            float num7 = 0.6f;
            float num8 = 1f; // Increases the base scale
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = new Color(25, 175, 55); // Back Swing
            ...
            Color color2 = new Color(85, 205, 125, 125); // Front Swing
            // Color color3 = new Color(255, 255, 200, 80);
            Color color4 = new Color(255, 255, 255) * num3 * 0.8f; // Lines
