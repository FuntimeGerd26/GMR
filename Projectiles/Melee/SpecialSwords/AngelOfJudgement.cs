...
{
    public class AngelOfJudgement : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float num7 = 0.6f;
            float num8 = 1.6f; // Increases the hitbox and visuals
            ...
            {
                Dust dust7 = Dust.NewDustPerfect(Projectile.Center + num10.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), 68, vector3 * 1f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = new Color(55, 155, 195); // Back Swing
            ...
            Color color2 = new Color(185, 205, 255, 125); // Front Swing
            // Color color3 = new Color(255, 255, 200, 80);
            Color color4 = new Color(205, 255, 255) * num3 * 0.5f; // Lines
