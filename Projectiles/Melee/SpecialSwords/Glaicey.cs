...
{
    public class Glaicey : ModProjectile
    {
        ...
        {
            Lighting.AddLight(Projectile.Center, new Vector3(0.2f, 0.2f, 0.75f));
            ...
            float num7 = 0.6f;
            float num8 = 0.9f; // Increases the hitbox and visuals
            ...
            {
                Dust dust7 = Dust.NewDustPerfect(Projectile.Center + num10.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), 80, vector3 * 1f);
                dust7.fadeIn = 0.4f + Main.rand.NextFloat() * 0.15f;
                dust7.noGravity = true;
                Dust dust8 = Dust.NewDustPerfect(Projectile.Center + num10.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), 80, vector3 * 1f);
                dust8.fadeIn = 0.4f + Main.rand.NextFloat() * 0.15f;
                dust8.noGravity = true;
            }
            if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
            {
                var dust9 = Dust.NewDustPerfect(vector2, 80, vector3 * 1f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = new Color(55, 110, 125); // Back Swing
            ...
            Color color2 = new Color(85, 150, 185, 125); // Front Swing
            // Color color3 = new Color(255, 255, 200, 80);
            Color color4 = new Color(205, 235, 255) * num3 * 0.5f; // Lines
