...
namespace GMR.Projectiles.Melee
{
    public class ElementalSpear : ModProjectile
    {
		...
		public override bool PreAI()
		{
			...
			{
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 6f, ModContent.ProjectileType<Projectiles.Melee.ElementalPlanteraPetal>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
			}
		...
		{
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center - 120 * Vector2.UnitY, new Vector2(0f, 6f), ModContent.ProjectileType<Projectiles.Melee.ElementalOceanCoin>(), Projectile.damage, 4f, Main.myPlayer);
