	...
	public class JackSwordExplode : ModProjectile
	{
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			if (player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.ArkBomb>()] < 1)
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, new Vector2(0f, 0f), ModContent.ProjectileType<Projectiles.ArkBomb>(), (int)(Projectile.damage * 0.75), Projectile.knockBack, Main.myPlayer);
