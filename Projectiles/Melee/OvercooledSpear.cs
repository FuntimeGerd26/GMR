...
namespace GMR.Projectiles.Melee
{
    public class OvercooledSpear : ModProjectile
    {
		...
		public override bool PreAI()
		{
			...
			{
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), player.Center, Projectile.velocity * 8f, ModContent.ProjectileType<Projectiles.Melee.OvercooledSpearHoming>(), Projectile.damage, Projectile.knockBack, player.whoAmI);
			}
