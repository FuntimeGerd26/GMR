...
{
    public class XShotVice : ModProjectile
    {
		...
		public override bool PreAI()
		{
			...
			{
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 6f, ModContent.ProjectileType<Projectiles.Melee.XShotBlade>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
			}
