...
{
	public class ThousandEdge : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				rotMod += 3.14f;
				Projectile.velocity = Projectile.velocity.RotatedBy(MathHelper.ToRadians(rotMod));
				Projectile.velocity *= 0.95f;
			}
			else
            {
				Vector2 targetCenter = Main.MouseWorld;
				Projectile.velocity = Vector2.Normalize(targetCenter - Projectile.Center) * 28f;
            }				
