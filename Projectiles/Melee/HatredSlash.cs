...
namespace GMR.Projectiles.Melee
{
	public class HatredSlash : ModProjectile
	{
		...
		public override Color? GetAlpha(Color lightColor) => new Color(255, 55, 155, 0) * Projectile.Opacity;
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Color color26 = new Color(255, 25, 125, 0) * opacity;
			...
			Main.EntitySpriteDraw(ModContent.Request<Texture2D>($"GMR/Projectiles/Melee/SwordSlashSmall_Light", AssetRequestMode.ImmediateLoad).Value, Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY),
				new Microsoft.Xna.Framework.Rectangle?(rectangle), new Color(255, 125, 155, 0) * opacity, Projectile.rotation, origin2, Projectile.scale, spriteEffects, 0);
			return false;
		}
	}
}