...
{
	public class DextreaSlash : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            Projectile.rotation += MathHelper.ToRadians(Projectile.direction * 36);
            if (Projectile.rotation > MathHelper.TwoPi) Projectile.rotation -= MathHelper.TwoPi;
            if (Projectile.scale > 0.1f) Projectile.scale -= 0.01f;
            Projectile.damage = (int)((Projectile.originalDamage * Projectile.scale) / 2);
            Lighting.AddLight(Projectile.Center, new Vector3(0.2f, 0.2f, 0.2f));
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            int dustId = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.SilverFlame, Projectile.velocity.X * 0.5f,
                Projectile.velocity.Y * 0.5f, 91, Color.White, 2f);
