...
namespace GMR.Projectiles.Melee
{
	...
	{
		public override string Texture => "GMR/Items/Weapons/Melee/AngelOfJudgement";
		...
		{
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<Projectiles.Explotion>(), Projectile.damage * 3, Projectile.knockBack, Main.myPlayer);
