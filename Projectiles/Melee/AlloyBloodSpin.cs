...
namespace GMR.Projectiles.Melee
{
    ...
    {
        public override string Texture => "GMR/Items/Weapons/Melee/Swords/AlloybloodSword";
        ...
        public override void AI()
        {
            ...
            Projectile.localNPCHitCooldown = 30 - (int)(15 * (spinValAdd / 6));
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.InfraRedExplosion>()] < 3)
                Projectile.NewProjectile(player.GetSource_FromThis(), target.Center, new Vector2(0f, 0f), ModContent.ProjectileType<Projectiles.InfraRedExplosion>(),
    ...
    public class AlloybloodSpinThrow : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.localNPCHitCooldown = 30 - (int)(15 * atkSpeedBuffs);
            if (Projectile.localNPCHitCooldown < 5)
                Projectile.localNPCHitCooldown = 5;
        }
