...
namespace GMR.Projectiles.Melee
{
	public class AngelOfJudgementThrow : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Projectile.velocity *= 30f * VelMult;
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			if (Projectile.alpha < 200)
			{
				for (int i = 0; i < 30; i++)
				{
					var d = Dust.NewDustDirect(target.position, target.width, target.height, 68, newColor: Color.White, Scale: 1f);
					d.velocity *= 0.4f;
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Color color = new Color(55, 155, 195);
			color *= opacity;
			...
			Color color2 = new Color(185, 205, 255, 125);
			//Color color3 = new(227, 182, 245, 80);
			Color color4 = new Color(205, 255, 255) * num3 * 0.5f;
