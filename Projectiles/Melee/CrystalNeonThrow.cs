...
namespace GMR.Projectiles.Melee
{
	public class CrystalNeonThrow : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (target != null)
			{
				Projectile.velocity = Vector2.Lerp(Projectile.velocity, Vector2.Normalize(target.Center - Projectile.Center) * 10f, 0.075f);
			}
		...
		{
			Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity / 2f, ModContent.ProjectileType<Projectiles.Melee.CrystalNeonBlades>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
		}
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			{
				Color color26 = new Color(255, 110, 185, 125) * ((Projectile.oldPos.Length - i) / (float)Projectile.oldPos.Length);
