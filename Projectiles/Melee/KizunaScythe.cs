...
namespace GMR.Projectiles.Melee
{
	public class KizunaScythe : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			var flareColor = new Color(255, 100, 185, 125) * num3 * 0.5f * opacity;
			...
			Texture2D texture2D13 = GMR.Instance.Assets.Request<Texture2D>("Items/Weapons/Melee/KizunaScythe", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
			...
			for (int i = 0; i < ProjectileID.Sets.TrailCacheLength[Projectile.type]; i++)
			{
				...
				Main.EntitySpriteDraw(texture2D13, Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY), null,
					color26 * opacity * 0.5f * num3, Projectile.rotation, origin2, Projectile.scale, spriteEffects, 0);
				...
				Main.EntitySpriteDraw(texture2D13, value4 + Projectile.Size / 2f - Main.screenPosition + new Vector2(0, Projectile.gfxOffY), null,
					color27 * opacity * 0.5f * num3, num165, origin2, Projectile.scale, spriteEffects, 0);
			}
			return false;
		}
	}
