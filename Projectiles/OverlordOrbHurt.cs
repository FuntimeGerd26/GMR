...
{
	public class OverlordOrbHurt : ModProjectile
	{
		public override string Texture => "GMR/Projectiles/GlowSprite";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Mech-Overlord Trail");
		...
		public override Color? GetAlpha(Color lightColor) => new Color(255, 209, 135, 125);
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Color color26 = new Color(255, 209, 135, 125);
