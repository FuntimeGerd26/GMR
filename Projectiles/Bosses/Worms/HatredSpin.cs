...
{
	public class HatredSpin : ModProjectile
	{
		public override string Texture => "GMR/Projectiles/Melee/SmallSpin";

		public Vector2? ForcedTargetPosition { get; set; }

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Hateful Spin");
		...
		public override void AI()
		{
			for (int i = 0; i < Main.maxPlayers; i++)
			{
				...
				Projectile.velocity = Vector2.Lerp(Projectile.velocity, Vector2.Normalize(targetPlayer - Projectile.Center) * 5f, 0.09f);
			}
