...
{
	public class MagmaSummon : ModProjectile
	{
		public override string Texture => "GMR/Projectiles/Melee/MagmaEdge";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Magmatic Sword");
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			for (int i = 0; i < trailLength; i++)
			{
				...
				Main.EntitySpriteDraw(texture, Projectile.oldPos[i] + drawOffset, frame, new Color(200, 90, 40, 0) * progress * opacity, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0);
			}
