...
{
    public class MaySaw : ModProjectile
    {
        public override string Texture => "GMR/Projectiles/Summon/MaySaw";

        public int rotationDirection;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Violet Sawblade");
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity , ModContent.ProjectileType<Projectiles.Summon.MaySword>(), Projectile.damage / 2, Projectile.knockBack, Main.myPlayer);
