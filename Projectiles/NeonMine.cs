...
{
	public class NeonMine : ModProjectile
	{
		public override string Texture => "GMR/Projectiles/GlowSprite";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Neon Mine");
		...
		public override Color? GetAlpha(Color lightColor) => new Color(255, 25, 25, 0);
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Color color26 = new Color(255, 25, 25, 0);
