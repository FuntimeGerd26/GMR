...
{
    public class JackEArmGun : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            var glow = GMR.Instance.Assets.Request<Texture2D>($"NPCs/Bosses/Jack/Eternity/JackEArmGun_Glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
