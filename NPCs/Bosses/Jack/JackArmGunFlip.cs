    ...
    public class JackArmGunFlip : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (++NPC.localAI[1] > 120)
            {
                ...
                {
                    Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center, new Vector2(-25f, 20f), ModContent.ProjectileType<Projectiles.Bosses.JackBlastBad>(), NPC.damage / 2, 1f, Main.myPlayer, NPC.whoAmI);
                ...
                {
                    Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center, new Vector2(-25f, 20f), ModContent.ProjectileType<Projectiles.Bosses.AttackPreview>(), 0, 1f, Main.myPlayer, NPC.whoAmI);
                }
            }
        }
    }
