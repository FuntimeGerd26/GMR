...
namespace GMR.NPCs.Bosses.Jack
{
    public class JackArmClawFlip : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D glowtexture = Terraria.GameContent.TextureAssets.Npc["NPCs/Bosses/Jack/JackArmClawFlip_Glow"].Value;
            SpriteEffects effects = SpriteEffects.None;
            Color glow = new Color(255, 255, 255, 255);
            Color main = new Color(255, 255, 255, 255);
