...
namespace GMR.NPCs.Bosses.Jack
{
    public class JackArmClawFlip : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center, new Vector2(-25f, 0f), ModContent.ProjectileType<Projectiles.Bosses.JackArmClawFlip>(), NPC.damage, 1f, Main.myPlayer, NPC.whoAmI);
