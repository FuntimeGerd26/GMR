...
{
	public class MagmaGreatSword : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Magma Great Sword");
		...
		public override void AI()
		{
            ...
            Projectile.velocity = Projectile.velocity.RotatedBy(MathHelper.ToRadians(3f));
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Main.EntitySpriteDraw(texture, Projectile.position + drawOffset, frame, Projectile.GetAlpha(lightColor) * (opacity / 2), Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0);
